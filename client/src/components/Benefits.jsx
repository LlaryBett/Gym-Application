        ...
        <div className="space-y-12">
          {BENEFITS.map((benefit, index) => {
            ...
            return (
              <div 
                key={benefit.id} 
                className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-start gap-8 lg:gap-12`}
              >
                <div className="flex-1 space-y-6">
                  ...
                  {benefit.features && (
                    <div className={benefit.id === 1 ? "grid grid-cols-2 gap-4" : benefit.id === 3 ? "flex flex-wrap gap-3" : "grid grid-cols-1 gap-3"}>
  ...
  {idx + 1}
                    ...
                    <div className="flex items-center justify-start gap-4 text-center">
                      {benefit.stats.map((stat, idx) => (
                        <div key={idx} className="flex items-center gap-4">
                          <div>
                            <div className="text-2xl md:text-3xl font-bold text-black-900">
                              {stat.number}
                            </div>
                ...
                <div className="flex-1">
                  ...
                  {benefit.image && !benefit.images && (
                    <div className="relative rounded-xl overflow-hidden shadow-lg h-[320px] w-full">
                      <img
                        src={benefit.image}
                        alt={benefit.title}
                  ...
                  {benefit.id === 2 && benefit.images && (
                    <div className="grid grid-cols-2 gap-3 h-[320px]">
                      <div className="flex flex-col gap-3">
                        <div className="relative rounded-xl overflow-hidden shadow-lg h-[154px] w-full">
                          <img
                 ...
                 {benefit.id === 3 && benefit.images && (
                    <div className="relative h-[320px] w-full flex items-center">
                      ...
                      <div className="absolute right-8 -top-8 w-44 h-44 rounded-xl overflow-hidden shadow-lg z-10">
                        <img
                          src={benefit.images[0]}
                      ...
                      <div className="relative w-96 h-64 rounded-xl overflow-hidden shadow-xl z-20">
                        <img
                          src={benefit.images[1]}
